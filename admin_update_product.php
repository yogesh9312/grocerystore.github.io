   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         <option selected><?= $fetch_products['category']; ?></option>
               <option value="attaricedal">atta,rice&dal</option>
               <option value="masalaoilgheemore">masala,oil,ghee&more</option>
               <option value="snacks">snacks&beverages</option>
               <option value="personalcarecleaning">personalcare&cleaning</option>
               <option value="homekitchen">home&kitchen</option>
               <option value="dairyeggs">dairy&eggs</option>
               <option value="fresh">freshfruits&vegetables</option>
